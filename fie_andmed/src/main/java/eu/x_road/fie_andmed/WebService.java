...
public class WebService extends Service {
    ...
    public final static QName SERVICE = new QName("http://fie_andmed.x-road.eu", "webService");
    public final static QName Port = new QName("http://fie_andmed.x-road.eu", "port");
    static {
